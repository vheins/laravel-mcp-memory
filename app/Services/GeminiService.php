...
class GeminiService
{
    ...
    public function enhanceMemory(array $currentData, string $instruction): array
    {
        ...
        throw_unless($apiKey, Exception::class, 'Gemini API key is not configured.');
        ...
        try {
            ...
            Log::error('Gemini Enhancement Exception', ['message' => $exception->getMessage()]);
    ...
    public function generateMemoryFromPrompt(string $prompt): array
    {
        ...
        try {
            ...
            Log::error('Gemini Generation Exception', ['message' => $exception->getMessage()]);
